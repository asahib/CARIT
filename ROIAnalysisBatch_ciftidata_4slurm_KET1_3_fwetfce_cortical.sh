...
Subjlist=$(<$maindir/logstxt/Sublist_k41.txt) #Space delimited list of subject IDs
...
#Cortical ROIs:
ROIlist="L_cuneus L_pericalcarine L_inferiortemporal L_superiorparietal L_superiortemporal L_middletemporal L_inferiorparietal L_lateraloccipital R_caudalmiddlefrontal R_superiorfrontal R_superiorparietal R_supramarginal R_parsopercularis R_parsorbitalis R_parstriangularis R_lateralorbitofrontal R_inferiorparietal"  
